...
import {Text, Animated, StyleProp, TextStyle, View, ViewStyle} from 'react-native';
...
export class AnimatedEllipsis extends Component<Props> {
    ...
    animate_dots(which_dot) {
        if (!this.animationState.should_animate) return;
    ...
    render() {
        let dots = this.animationState.dot_opacities.map((o, index) =>
            <Animated.View key={index} style={{opacity: o}}>
