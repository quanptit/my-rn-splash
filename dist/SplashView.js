...
export class SplashView extends PureComponent {
    ...
    render() {
        ...
        return (<TypeLinearGradient colors={['#247d9b', '#4da0b7', '#87d1de']} style={[{ position: 'absolute', left: 0, top: 0, right: 0, bottom: 0 }, containerStyle]}>
                <Col flex={1} dial={5}>
                    <Image source={this.props.appIcon} style={{ width: 80, height: 80 }}/>
